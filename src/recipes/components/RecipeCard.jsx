  ...
  return (
    <article
      className={cn(
        ...
        compact ? "min-h-[380px]" : "min-h-[480px] max-[600px]:min-h-[420px]",
        `recipe-card--${variant}`,
    ...
    >
      <a
        className={cn(
          "recipe-card__link relative z-[2] flex flex-col justify-end h-full p-6 max-[600px]:p-[18px] text-white no-underline box-border focus-visible:outline-2 focus-visible:outline-white focus-visible:-outline-offset-2",
          compact ? "min-h-[380px]" : "min-h-[480px] max-[600px]:min-h-[420px]"
        )}
      ...
      >
        ...
        <div className="recipe-card__body relative z-[2] flex flex-col p-0">
          {recipe.category && (
            <span className="recipe-card__category inline-block mb-1.5 text-[#e58d7c] text-[11px] max-[768px]:text-[10px] font-bold tracking-[0.08em] uppercase">
              {recipe.category}
            </span>
          )}
          <h2 className="recipe-card__title m-0 mb-2 text-white font-serif text-[26px] max-[600px]:text-[22px] font-medium leading-[1.15] tracking-[-0.01em] [text-shadow:0_2px_8px_rgba(0,0,0,0.3)]">
            {recipe.title}
          </h2>
